...
readonly alloc_all="sys wl dh ff fg gd hd hm hml iso je lp lt mi mi-sec mng mesh nomesh rp sc scudo sg sm sn sn-sec tbb tc tcg dmi xmi xsmi xdmi"
...
alloc_installed="sys wl"  # later expanded to include all installed allocators
...
alloc_lib_add "wl"     "$localdevdir/wl/libwlmalloc$extso"
