...
#ifdef HOLES
#   define HOLE() gc_malloc(sizeof(Node0));
#else
#   define HOLE()
#endif
...
static void Populate(int iDepth, Node thisNode) {
        if (iDepth<=0) {
                ...
                iDepth--;
#		ifdef GC
                  thisNode->left  = gc_calloc(1, sizeof(Node0)); HOLE();
                  thisNode->right = gc_calloc(1, sizeof(Node0)); HOLE();
#		else
...
#	    else
		result = gc_calloc(1, sizeof(Node0)); HOLE();
#	    endif
...
#	    else
		result = gc_malloc(sizeof(Node0)); HOLE();
#	    endif
